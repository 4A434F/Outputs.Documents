...
namespace Outputs.Documents.FSCD.Templates.IntegrationTests.Fixtures;

public sealed class FscdTemplateRenderingFixture : IDisposable
{
    private readonly ServiceProvider? _provider;

    public FscdTemplateRenderingFixture()
    {
    ...
    private static string? GetLicenseKey()
    {
        var configuration = new ConfigurationBuilder()
            .AddUserSecrets<FscdTemplateRenderingFixture>(optional: true)
