...
public sealed class DocePreviewScenarios : IDocumentPreviewScenarioProvider
{
    ...
    {
        yield return new("cover-short", "Cover page with destination", typeof(CoverPage), Samples.CoverPageShort());
        yield return new("cover-full", "Cover page summary only", typeof(CoverPage), Samples.CoverPageFull());
        yield return new("dispatch-standard", "Dispatch with many rows", typeof(CttDispatchSheet), Samples.DispatchSheet());
        yield return new("urgent", "Urgent divider", typeof(Divider), new Divider("Urgente"));
        yield return new("standard", "Standard delivery note", typeof(DeliveryNote), Samples.DeliveryNote());
        yield return new("standard", "Standard courtesy letter", typeof(DoceCourtesyLetter), Samples.CourtesyLetter());
        yield return new("four-tickets", "Four registered tickets", typeof(RegTicketPage), Samples.RegTicketPage());
    }
