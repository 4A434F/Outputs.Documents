...
using DeliveryNoteContract = Outputs.Documents.Domain.Contracts.DOCE.DC004DeliveryNote;

namespace Outputs.Documents.Domain.Samples.DOCE.DC004DeliveryNote;
